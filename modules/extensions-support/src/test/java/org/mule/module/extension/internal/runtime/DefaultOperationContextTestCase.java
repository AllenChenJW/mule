...
public class DefaultOperationContextTestCase extends AbstractMuleTestCase
{
    ...
    public static final String VALUE = "Do you want to build a snowman?";
    ...
    public void onOperationSuccessful()
    {
        ...
        operationContext.onOperationSuccessful(event -> value.set(event.getResult()));
    ...
    public void onOperationFailed()
    {
        ...
        operationContext.onOperationFailed(event -> exceptionHolder.set(event.getException()));
